...
#define DECLARE_STATIC_LOGGER							static log4cplus::Logger LOGGER;
#define DEFINE_LOGGER(name)								LOGGER = log4cplus::Logger::getInstance(LOG4CPLUS_TEXT(name));
#define DEFINE_STATIC_LOGGER(clazz, name)				log4cplus::Logger clazz::LOGGER = log4cplus::Logger::getInstance(LOG4CPLUS_TEXT(name));
